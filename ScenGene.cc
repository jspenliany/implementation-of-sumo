...
const static string key_route[24] = {
					...
					"poisson_lambda","trip_divide_num","edge_backCycle","vehi_departLane"};
...
//				strtmp<<"$ns_ duplex-link-op $nodew_("<<(wired_startIndex + ri - 1)<<") $nodew_("<<(wired_startIndex + ri)<<") orient right\n";
			...
			strtmp<<"$ns_ duplex-link-op $nodew_("<<(wired_startIndex + (node_rowc-1))<<") $nodew_("<<(wired_startIndex + Base_Num - 1 + New_Index)<<") orient left-up\n";
			...
			strtmp<<"$ns_ duplex-link-op $nodew_("<<(wired_startIndex + (Base_Num - node_rowc))<<") $nodew_("<<(wired_startIndex + Base_Num - 1 + New_Index)<<") orient right-down\n";
